...
CREATE TABLE "new_credits" (
    ...
    "link" TEXT NOT NULL,
    "article_id" TEXT,
    CONSTRAINT "credits_article_id_fkey" FOREIGN KEY ("article_id") REFERENCES "articles" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_favorite_articles" (
    ...
    "user_id" TEXT NOT NULL,
    "article_id" TEXT,
    CONSTRAINT "favorite_articles_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "favorite_articles_article_id_fkey" FOREIGN KEY ("article_id") REFERENCES "articles" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
