...
INSERT INTO "new_articles" ("category_id", "created_at", "id", "manager_id", "slug", "state", "subtitle", "text", "title") SELECT "category_id", "created_at", "id", "manager_id", "slug", "state", "subtitle", "text", "title" FROM "articles";
DROP TABLE "articles";
